    ...
    function fnOnRowAdding(event) {
        if (oAddNewRowForm.valid()) {
            ...
            var params = {
                ...
                'AssignDept': $('#AssignDept').val(),
                'floor': $('#OtherData').val(),
                'Equipid': $('#Equipid').val(),
                'equidname': $('#equidname').val(),
                'Status': $('#Status').val(),
            ...
            if (oAddNewRowForm.length != 0) {
                ...
                if (oAddNewRowButton.length != 0) {
                    oAddNewRowButton.click(function () {
                        ...
                        $('#Creatordept option').each(function () {
                            if ($(this).text() == creatordepartment) {
                ...
                if (oConfirmRowAddingButton.length == 0) {
                    oAddNewRowForm.append("<button class='button success' id='" + properties.sAddNewRowOkButtonId + "'>Ok</button>");
                    oConfirmRowAddingButton = $("#" + properties.sAddNewRowOkButtonId, oAddNewRowForm);
                }
                ...
                if (oCancelRowAddingButton.length == 0) {
                    oCancelRowAddingButton = oAddNewRowForm.append("<button class='button danger' id='" + properties.sAddNewRowCancelButtonId + "'>Cancel</button>");
                    oCancelRowAddingButton = $("#" + properties.sAddNewRowCancelButtonId);
                }
